...
namespace AldurSoft.Core.Eventing {
    ...
    public interface ISubscribe<TMessage> : ISubscribe {  //don't use contravariance here
        /// <summary>
        ///   Handles the message.
        /// </summary>
    ...
    public interface IMessageAggregator {
        ...
        /// <summary>
        ///   Subscribes an instance to all events declared through implementations of <see cref = "ISubscribe{TMessage}" />
        /// </summary>
        ...
        void Send(object message, Action<System.Action> marshal);
    }
    ...
    public class MessageAggregator : IMessageAggregator {
        ...
        /// <param name = "message">The message instance.</param>
        /// <param name = "marshal">Allows the publisher to provide a custom thread marshaller for the message publication.</param>
        public virtual void Send(object message, Action<System.Action> marshal) {
            if (message == null){
                throw new ArgumentNullException("message");
            }
            if (marshal == null) {
        ...
        class Handler {
            ...
            public Handler(object handler) {
...
#if WinRT
                var handlerInfo = typeof(ISubscribe).GetTypeInfo();
                ...
                var interfaces = handler.GetType().GetInterfaces()
                    .Where(x => typeof(ISubscribe).IsAssignableFrom(x) && x.IsGenericType);

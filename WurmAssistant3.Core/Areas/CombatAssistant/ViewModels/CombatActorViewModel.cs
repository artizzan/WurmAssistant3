...
namespace AldursLab.WurmAssistant3.Core.Areas.CombatAssistant.ViewModels
{
    public class CombatActorViewModel
    {
        ...
        [UsedImplicitly]
        public float FightingSkillGained
        {
            get { return AttackerActor.FightingSkillGained; }
        }

        [UsedImplicitly]
        public float FightingSkillGainedPerKill
        {
            get { return FightingSkillGained / SlainCount; }
        }
    }
}

...
{
    public partial class FormEditValuePresets : Form
    {
        ...
        void RebuildAllPresetsList()
        {
            ...
            allPresets.Add(TraitValuator.DEFAULT_id);
        ...
        {
            if (listBox1.SelectedIndex < 0) MessageBox.Show("select a preset to copy values from");
            else if (listBox1.SelectedItem.ToString() == TraitValuator.DEFAULT_id) MessageBox.Show("default preset can't be deleted");
            else
            {

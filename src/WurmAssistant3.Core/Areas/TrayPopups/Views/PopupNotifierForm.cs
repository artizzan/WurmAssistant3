...
using AldursLab.WurmAssistant3.Core.Areas.TrayPopups.Resources;
    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                // create this window with no-activate style to prevent stealing focus
        ...
        private void PopupNotifierForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (Parent.ShowGrip)
            {
                e.Graphics.DrawImage(TrayPopupsResources.Grip, (int)((this.Width - TrayPopupsResources.Grip.Width) / 2), (int)((Parent.HeaderHeight - 3) / 2));
            }
            if (Parent.ShowCloseButton)
            {
                if (mouseOnClose)

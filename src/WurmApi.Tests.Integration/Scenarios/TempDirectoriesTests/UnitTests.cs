...
namespace AldursLab.WurmApi.Tests.Integration.Scenarios.TempDirectoriesTests
{
    [TestFixture]
    public class UnitTests : AssertionHelper
    {
        static readonly string LocalTestResourcePath = Path.Combine("Scenarios", "TempDirectoriesTests");

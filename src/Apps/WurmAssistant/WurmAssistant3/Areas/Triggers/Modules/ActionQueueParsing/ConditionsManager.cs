...
using AldursLab.WurmAssistant3.Areas.Triggers.Views.ActionQueueParsing;
using Newtonsoft.Json;

namespace AldursLab.WurmAssistant3.Areas.Triggers.Modules.ActionQueueParsing
{
    [PersistentObject("ActionQueueParsing_ConditionsManager")]
